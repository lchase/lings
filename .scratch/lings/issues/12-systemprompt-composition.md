...
**Blocked by:** 06 — Laws & permissions, 09 — Bots: entity + ad-hoc chat, 10 — Bot memory, 11 — Bot skills config.

**Status:** ready-for-agent

- [ ] Starting a session resolves the effective laws doc for its folder (per ticket 06's nearest-ancestor rule).
